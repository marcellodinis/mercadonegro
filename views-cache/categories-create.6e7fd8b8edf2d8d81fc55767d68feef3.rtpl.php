...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/mandachuva/categories">Categorias</a></li>
    <li class="active"><a href="/mandachuva/categories/create">Registar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/mandachuva/categories/create" method="post">
          <div class="box-body">
